...
- ![Trajectory plot](({{ site.baseurl }}/assets/docs/3D_Trajectory.png))
...
- ![Simulation Environment with Drones]({{ site.baseurl }}/assets/docs/drones_in_simenv.png)
...
- ![Anomalies on the Lunar Anomalies]({{ site.baseurl }}/assets/docs/lunar_anomaly.png)
